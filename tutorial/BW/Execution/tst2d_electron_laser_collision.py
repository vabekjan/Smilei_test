...
gamma = 4000./0.511                     # Beam gamma factor
v = math.sqrt(1 - 1./gamma**2)          # Initial beam velocity

# _____________________________________________________________________________
# Density profile for inital location of the particles and photons

def n0_electron(x,y):
        if ((0.98*Lx < x < 0.99*Lx)and(0.49*Ly < y < 0.51*Ly)):
                return n0
        else:
                return 0.
...
# ______________________________________________________________________________
# Namelist configuration of the multiphoton Breit-Wheeler pair creation
