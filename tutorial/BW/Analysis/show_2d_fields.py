...
im0 = ax0.imshow(f, cmap="jet", extent=[x[0],x[-1],y[0],y[-1]], aspect="auto", interpolation="nearest")
...
im1 = ax1.imshow(f, cmap="jet", extent=[x[0],x[-1],y[0],y[-1]], aspect="auto", interpolation="nearest")
